        ...
        <Container>
          ...
          <Accordion className="custom-accordion">
            <Accordion.Item eventKey="0">
              <Accordion.Header>1. What kind of placement assistance does Mission Engineering provide?</Accordion.Header>
              <Accordion.Body>
                We provide comprehensive placement assistance which includes aptitude training, technical interview preparation, mock interviews, and resume building workshops.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="1">
              <Accordion.Header>2. Are there any specific companies that recruit students from your institute?</Accordion.Header>
              <Accordion.Body>
                Yes, our students have successfully secured placements in top companies like Maruti Suzuki, Daikin, and various other leading engineering and manufacturing firms.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="2">
              <Accordion.Header>3. Do you offer interview preparation and resume building sessions?</Accordion.Header>
              <Accordion.Body>
                Absolutely. We dedicate specific sessions entirely to crafting professional resumes and teaching effective communication skills to excel in HR and technical interviews.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="3">
              <Accordion.Header>4. How long is the placement coaching program?</Accordion.Header>
              <Accordion.Body>
                The placement program duration varies depending on the specific batch and student requirements, but typically runs for 2 to 3 months leading up to the placement season.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="4">
              <Accordion.Header>5. Is the placement program available online?</Accordion.Header>
              <Accordion.Body>
                Yes, we offer both offline classroom training and online live sessions through the Mission Engineering App, making it convenient for all students.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="5">
              <Accordion.Header>6. Can alumni access placement assistance after completing their course?</Accordion.Header>
              <Accordion.Body>
                We offer continued guidance and share placement opportunities with our alumni network to ensure their long-term career success.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="6">
              <Accordion.Header>7. What is the success rate of your placement program?</Accordion.Header>
              <Accordion.Body>
                Mission Engineering boasts a high success rate, with hundreds of our students securing lucrative job offers in core engineering sectors every year.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="7">
              <Accordion.Header>8. Are there mock interviews conducted during the training?</Accordion.Header>
              <Accordion.Body>
                Yes, mock interviews are a core part of our curriculum. We conduct multiple rounds of technical and HR mock interviews with expert faculty.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="8">
              <Accordion.Header>9. Do you provide guidance for aptitude and technical tests?</Accordion.Header>
              <Accordion.Body>
                Yes, our coaching covers quantitative aptitude, logical reasoning, and core technical subjects required to clear the initial screening rounds.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="9">
              <Accordion.Header>10. Who can enroll in the placement coaching program?</Accordion.Header>
              <Accordion.Body>
                Any polytechnic or engineering student looking to secure a campus or off-campus placement can enroll in our dedicated placement preparation batches.
              </Accordion.Body>
            </Accordion.Item>
          </Accordion>
        </Container>
